            ...
            try:
                with open('treinos.txt', 'r', encoding='utf8') as arquivotxt:
                    ...
                    if dis_ou_temp == "D":
                        ...
                        if filtrados:
                            print("\nEsses são os treinos filtrados por distância:")
                        ...
                        if filtrados:
                            print("\nEsses são os treinos filtrados por tempo: ")
                            for treino in filtrados:
                                print(treino.strip())
                        else:
                            print("\nNenhum treino encontrado.")
            ...
            try:
                with open('competicoes.txt', 'r', encoding='utf8') as arquivotxt:
                    ...
                    if dis_ou_temp == "D":
                        ...
                        if filtrados:
                            print("\nEssas são as competições filtrados por distância:")
                        ...
                        if filtrados:
                            print("\nEssas são as competições filtrados por tempo: ")
                            for competicao in filtrados:
                                print(competicao.strip())
                        else:
                            print("\nNenhuma competicao encontrada.")
                    else:
                        print("Opção inválida")
            except FileNotFoundError:
